...
namespace TransportToStadiumAgentSimulation.gui
{
    public partial class MainForm : Form
    {
        ...
        private readonly double endTime = 6000;
        private bool paused;
        private readonly MySimulation simulation;
        private readonly double startTime = startHour * 3600 + startMinute * 60 + startSecond;
        ...
        {
            if (paused) simulation.ResumeSimulation();
        ...
        {
            var fastMode = checkBoxFastMode.Checked;
        ...
        private void textBoxLineAVehicles_TextChanged(object sender, EventArgs e)
        {
            try
            {
                var lineVehiclesString = textBoxLineAVehicles.Text;
        ...
        private void textBoxLineBVehicles_TextChanged(object sender, EventArgs e)
        {
            try
            {
                var lineVehiclesString = textBoxLineBVehicles.Text;
        ...
        private void textBoxLineCVehicles_TextChanged(object sender, EventArgs e)
        {
            try
            {
                var lineVehiclesString = textBoxLineCVehicles.Text;
